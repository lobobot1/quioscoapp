  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div className="flex flex-col">
        <button
          type="button"
          className="bg-sky-500 flex px-5 text-white rounded-md font-bold uppercase shadow-md w-full text-center hover:bg-sky-700 transition-colors duration-300 ease-in-out"
        ...
        <button
          type="button"
          className="bg-red-500 flex px-5 mt-3 text-white rounded-md font-bold uppercase shadow-md w-full text-center hover:bg-red-700 transition-colors duration-300 ease-in-out"
